...
.PARAMETER resources
destination file names that need to be added as resoruces to the application '-resources "helloworld.ps1"'
...
{
	[CmdletBinding()]
	Param([STRING]$inputFile = $NULL, [STRING]$outputFile = $NULL,[string[]]$resources, [SWITCH]$prepareDebug, [SWITCH]$x86, [SWITCH]$x64, [int]$lcid,
